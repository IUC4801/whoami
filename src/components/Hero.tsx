...
const Hero = () => {
  ...
  return (
    <section id="hero" className="min-h-screen flex flex-col justify-center relative px-6 overflow-hidden">
      {/* Grid background */}
      ...
      <div className="container mx-auto max-w-5xl z-10">
        <div className="space-y-6">
          <p 
            className="font-mono text-primary animate-fade-up"
          ...
          >
            <button
              ...
              className="group flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 font-mono text-sm font-medium transition-all duration-300 hover:glow-sm hover:scale-105"
            >
              Explore My Work
